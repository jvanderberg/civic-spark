...
- [ ] Retry Share once with a refreshed preview when only the preview fingerprint changed (client and runner); cap the `changes` payload; keep provisioning's Git bundling off the main loop.
