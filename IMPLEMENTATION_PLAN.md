...
- [ ] Cap the `changes` payload and keep provisioning's Git bundling off the main loop; re-run fifty with the zero-copy state reads and worker-owned integration relays deployed and attribute loop time per process.
