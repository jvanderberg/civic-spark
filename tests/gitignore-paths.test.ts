...
const cases = [
  ...
  ["src/app.ts", true],
  [".oxlintrc.json", true],
  ["app/.oxlintrc.json", true],
  [".prettierrc", true],
  [".editorconfig", true],
  ["app/.eslintrc.cjs", true],
  [".nvmrc", true],
  [".github/workflows/ci.yml", true],
  [".vscode/settings.json", true],
  [".env.example", true],
  [".gitignore/secret.txt", true],
  [".env", false],
  [".env.local", false],
  [".ENV", false],
  [".npmrc", false],
  ...
  [".civic-spark-sync.json", false],
  [".claude/.gitignore", false],
  [".opencode/state.json", false],
  [".DS_Store", false],
  [".cache/index.json", false],
...
it("keeps TypeScript and both Sprite filters in parity: hidden paths are project data unless private", () => {
